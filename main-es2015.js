...
let EmpComponent = class EmpComponent {
    constructor() {
        this.c = 'cls1';
        this.size = '16px';
        this.color = 'pink';
...
let FrmgroupComponent = class FrmgroupComponent {
    constructor(service) {
...
FrmgroupComponent.ctorParameters = () => [
...
let IfelsecompComponent = class IfelsecompComponent {
    constructor() {
        this.a = 0;
        this.x = 0;
        this.y = 0;
...
let LoopsComponent = class LoopsComponent {
    constructor() {
...
let StuformComponent = class StuformComponent {
    constructor() { }
    ngOnInit() {
    }
    stuform(data) {
...
let SwitchdemoComponent = class SwitchdemoComponent {
    constructor() {
        this.day = 1;
    }
    ngOnInit() {
